(() => {
    ...
    function initSliders() {
        if (document.querySelector(".info-top__slider", "decor-top__slider", ".gallery__slider")) {
            ...
            var topSwiper = new core(".info-top__slider", {
            ...
            var decorSwiper = new core(".decor-top__slider", {
                modules: [ Autoplay, Navigation, Pagination, EffectFade ],
                slidesPerView: "auto",
                centeredSlides: true,
                spaceBetween: 0,
            ...
            topSwiper.controller.control = decorSwiper;
            decorSwiper.controller.control = topSwiper;
        }
    }
